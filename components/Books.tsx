...
export default function Books({ }: Props) {
    return (
        <div className='flex flex-col h-screen relative justify-center items-center overflow-hidden max-w-7xl mx-auto px-10'>
            <h4 className='absolute top-24 uppercase tracking-[10px] font-bold'>Books</h4>
            <div className='relative w-full flex overflow-x-scroll items-center md:grid grid-cols-3 snap-x snap-mandatory gap-10'>
                <BookCard
