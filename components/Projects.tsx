...
export default function Projects({ }: Props) {
  return (
    <div className='flex flex-col justify-center items-center overflow-hidden max-w-7xl mx-auto px-10 mb-20 md:mb-40'>
      <h3 className='font-bold text-5xl md:text-6xl mb-14 text-left w-full sm:text-center sm:w-auto'>Projects +</h3>
      <div className='w-full flex flex-col items-center md:grid grid-cols-3 snap-x snap-mandatory gap-5'>
        <ProjectCard
