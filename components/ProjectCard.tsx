...
export default function ProjectCard({ projectName, description, link }: Props) {
    return (
        <div
            className='flex flex-col items-center justify-center flex-shrink-0 w-full md:max-w-sm md:max-h-60 snap-center p-5 border border-l-4 border-dark-gray hover:border-l-zinc-600 delay-50 transition ease-in-out duration-300'>
            <div className='my-2'>
